...
namespace Rander._2D
{
    public class Text2DComponent : OffsetComponent2D
    {
        ...
        {
            Game.Drawing.DrawString(Font, Text, LinkedObject.MathPos + Offset.Location.ToVector2(), Color, LinkedObject.MathRot, (LinkedObject.MathSz * LinkedObject.Pivot / FontSize) - (LinkedObject.MathSz * Pivot / FontSize) + PivotOffset, FontSize + Offset.Size.Y, SpriteEffects.None, LinkedObject.Layer + ((float)SubLayer / 1000));
        }
    }
}
